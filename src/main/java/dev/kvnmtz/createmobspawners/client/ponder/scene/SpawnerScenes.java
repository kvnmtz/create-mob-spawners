...
public abstract class SpawnerScenes {
    ...
    public static void spawner(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showControls(spawnerFaceUp, Pointing.DOWN, 40).rightClick().withItem(ModItems.SOUL_CATCHER.get().getDefaultInstance());
        scene.idle(7);
        ...
        scene.world().createEntity(world -> {
            ...
            pig.setPos(pig.xo = 1, pig.yo = 1, pig.zo = 1);
        ...
        scene.effects().emitParticles(Vec3.ZERO, (world, x, y, z) -> {
            ...
            ParticleUtils.drawPotionEffectLikeParticles(ParticleTypes.WITCH, world, bb, new Vec3(0.1, 0.1, 0.1), ParticleUtils.getParticleCountForBoundingBox(bb));
        }, 1, 1);
